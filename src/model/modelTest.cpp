...
main()
{
    ...
    passMang::User* u = new passMang::User(
        123, username, password, passMang::Role::Admin); // create new User
    ...
    passMang::Credential* c = new passMang::Credential(
        111, credName, email, username1, password1); // create new Credential
